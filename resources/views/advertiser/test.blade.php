...
<html lang="en">
  ...
  <body>
    ...
    <script src="https://maps.google.com/maps/api/js?key=AIzaSyC4C18bsU4pDdkJLDOKaEmAYdzcVytK4m4&libraries=places&callback=initAutocomplete" type="text/javascript"></script>
